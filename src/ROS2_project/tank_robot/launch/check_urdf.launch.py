...
def generate_launch_description():
    ...
    pkg_tank_robot = FindPackageShare('tank_robot')
    default_rviz_config_path = PathJoinSubstitution([pkg_tank_robot, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within tank_robot package
    model_arg = DeclareLaunchArgument(
        'model', default_value='enemy_photo.urdf',
